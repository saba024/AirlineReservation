...
namespace AirlineReseravtion.Controllers;
    ...
    public class FlightsController : Controller
    {
        ...
        public FlightsController(ApplicationDbContext context, IWebHostEnvironment appEnvironment)
        {
            _context = context;
        ...
        public IActionResult ViewMyFlights()
        {
            try
            {
        ...
        public ActionResult FlightDetails(int? id)
        {
         ...
         [AllowAnonymous]
        public ActionResult ViewBookedDetails(int? id)
        {
            if(id == null)
            {
                return StatusCode(StatusCodes.Status400BadRequest);
            }
            ReservationInfo flight = _context.ReservationInfos.Find(id);
        ...
        [Authorize(Roles = "Admin")]
        public IActionResult DeleteBookedFlight(int? id)
        {
            if(id == null)
            {
                return StatusCode(StatusCodes.Status400BadRequest);
            ...
            try
            {
                var flight = _context.ReservationInfos.Find(id);
                if(flight != null)
                {
                    _context.Remove(flight);
                    _context.SaveChanges();
